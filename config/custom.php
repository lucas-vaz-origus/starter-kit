...
return [
    'custom' => [
        ...
        'navbarBgColor' => 'light-green gmup-dark', //Options: cyan,teal,light-blue,amber (any of materializecolor class can be pass). warning:if isNavbarDark set NavbarBgColor not work.
        ...
        'isNavbarFixed' => false, // options:true or false
        'activeMenuColor' => 'light-green gmup', //Sidebar active menu color (any of materializecolor class can be pass)
        ...
        'activeMenuType' => 'sidenav-active-fullwidth', //Options:default("") sidenav-active-square, sidenav-active-rounded, sidenav-active-fullwidth  Warning:this option is not applicable for horizontal
        'isFooterDark' => null, //True for dark, flase for light and null for default
        'isFooterFixed' => false, //options:true or false
        'templateTitle' => 'GMUP', //template Title can be changes default('Materialize)
        'defaultLanguage' => 'pt-br', //set your default language Options: en(default),pt,fr,de
        'largeScreenLogo' => 'images/logo/materialize-logo-big.png', //we used saparete log image for large screen and small
